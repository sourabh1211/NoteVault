...
|------------|----------------|------------------|---------|-----------|--------------|--------|--------|
| ![Login](login.png) | ![SignUp](signup.png) | ![DashBoard/Home](Home.png) | ![Profile](Profile.png) | ![Add Note](AddNote.png) | ![SingleNotePage](singlenotepage.png) | ![NoPage](nopage.png) | ![Delete](delete.png) |
