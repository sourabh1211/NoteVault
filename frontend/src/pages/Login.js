          ...
          <div className="relative flex flex-col justify-center p-6 sm:p-10">
            ...
            >
              <div className="group relative">
                ...
                />
                <span className="pointer-events-none absolute inset-0 -z-10 rounded-xl opacity-0 blur-2xl transition group-hover:opacity-40 group-hover:blur-3xl group-focus-within:opacity-60" style={{ background: "radial-gradient(120px 60px at 20% 20%, rgba(139, 92, 246, .35), transparent)"}} />
              </div>
              ...
              <div className="group relative">
                <input
                  ...
                  className="peer w-full rounded-xl border border-white/15 bg-white/5 p-3 text-white placeholder-white/50 outline-none transition focus:border-violet-400/60 focus:ring-2 focus:ring-violet-500/40"
                />
                <span className="pointer-events-none absolute inset-0 -z-10 rounded-xl opacity-0 blur-2xl transition group-hover:opacity-40 group-hover:blur-3xl group-focus-within:opacity-60" style={{ background: "radial-gradient(120px 60px at 80% 80%, rgba(139, 92, 246, .35), transparent)"}} />
              </div>
            ...
            >
              Don&apos;t have an account?{" "}
              <Link className="font-medium text-violet-300 underline-offset-4 hover:underline" to="/signUp">
                Sign Up
              </Link>
            </motion.p>
          </div>
